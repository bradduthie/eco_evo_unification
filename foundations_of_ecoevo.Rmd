...
For example, $z$ might be interpreted as a trait that underlies an ecosystem function of interest such as carbon capture or photosynthetic rate.
...
Some measurable traits such as leaf pH [@Cornelissen2011] will not be ecologically meaningful when summed across individuals.
...
Hence, while we have argued that ecological and evolutionary change can both be derived from the same fundamental relationship between birth, death, and individual characteristics, the same is not true for ecosystem function.
