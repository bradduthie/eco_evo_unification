...
Using this formal definition, the scope of, and relationships across, sub-disciplines within evolutionary theory can be clarified.
...
In biological populations, ecological change is caused by the same processes of individual birth and death that cause changes in allele frequencies and phenotypes [@Turchin2001; @Connor2004].
...
@Turchin2001 argues that general principles are needed to establish a logical foundation for population ecology and argues for this simple birth and death model and the consequences that logically follow from it (e.g., exponential population growth) as fundamental laws of population ecology.
...
Our approach is distinct from eco-evolutionary modelling, which instead focuses on feedbacks between ecological and evolutionary dynamics.
While the interdependence of ecological and evolutionary processes has long been recognised [e.g., @Pelletier2009; @Fisher1958; @Darwin1859], the rise of models incorporating both is relatively recent following a widespread recognition that ecology and evolution can happen on similar timescales [@Yamamichi2023].
Eco-evolutionary models can be very general in their mathematical structure, thereby allowing for any number of ecological, evolutionary, or environmental feedbacks [e.g., @Lion2018; @Patel2018; @Govaert2019; @Lion2023].
Simplifying assumptions are necessary to make eco-evolutionary models tractable, but model assumptions can be developed from, or linked back to, fundamental equations such as the Price equation [e.g., @Coulson2008; @Barfield2011; @Lion2018].

[Okay, now state how a couple of these papers did cool things, and end by saying something about how we're trying to go a step back and establish foundations]


**Eco-evolutionary** is typically more broadly defined to mean any kind of feedback between ecology and evolution [Lion]
...
From eqn 1, we can derive the most fundamental equations of population ecology (Box 2) and evolutionary biology (Box 1) through an appropriate interpretation of $z_{i}$.
