---
title: "Darwin's Dream: Unifying ecological and evolutionary change"
author: |
...
The analogy to physics is imperfect because evolution encompasses non-biological systems with non-genetic inheritance [@Price1995; @Shennan2011; @MacCallum2012; @Lewens2015], but to illustrate our point, we restrict our focus to biological evolution.
...
Although many revelatory models exist to connect ecological and evolutionary phenomena [@Lion2018; @Patel2018; @Govaert2019], the foundational assumptions and equations of ecology and evolution in these models remain mostly separated conceptually. 
...
From the simple assumptions of population identity ($z_{i} = 1$) and invariability ($\Delta z_{i} = 0$), we recover the most general equation of population ecology (Box 1) and principle of exponential growth ($N_{t+1} = N_{t}\lambda$).
